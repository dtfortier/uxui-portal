...
?>
      ...
      <div class="blog-post" id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
        ...
        <?php if (is_page (array (9, 55, 51, 53))) : ?> <!-- change from 9 to 11 when saving for live -->
        <h2 class="blog-post-title"><i class="fa fa-picture-o"></i><?php the_title(); ?></h2>
       <?php elseif (is_page (array (11,68,62,66,64))) : ?>
...
<?php /* Sub Navigation */?>
        ...
        <?php
            if (is_page(array (9, 55, 51, 53))){ /* <!-- change from 9 to 11 when saving for live --> */
            wp_nav_menu( array(
            ...
            } elseif (is_page(array (11, 68, 62, 66, 64))) {
            wp_nav_menu( array(
